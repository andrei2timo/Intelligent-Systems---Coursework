...
num=5;                   % Maximum number of epochs = num * net.trainParam.epochs
...
% four of the curves are the Euclidean distance to the width and length of the petals and sepals respectively; the fifth curve being their total.   
